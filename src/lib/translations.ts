...
export const translations = {
  en: {
    ...
    performance: {
      ...
      subtitle: 'Paper-traded · Fully automated · Daily signals · No leverage',
      paperTraded: 'Paper-traded',
      fullyAutomated: 'Fully automated',
      dailySignals: 'Daily signals',
      noLeverage: 'No leverage',
      paperTradedTooltip: 'Trades executed in a simulated environment using real market data. No capital at risk.',
      ...
      howItWorksDesc: 'This performance is generated from daily trading signals executed automatically using predefined rules. Trades are entered on the next market close after a signal is generated. No manual intervention, no hindsight, no leverage.',
  ...
  es: {
    ...
    performance: {
      ...
      subtitle: 'Operación simulada · Ejecución automática · Señales diarias · Sin apalancamiento',
      paperTraded: 'Operación simulada',
      fullyAutomated: 'Ejecución automática',
      dailySignals: 'Señales diarias',
      noLeverage: 'Sin apalancamiento',
      paperTradedTooltip: 'Operaciones ejecutadas en un entorno simulado con datos de mercado reales. Sin capital en riesgo.',
      ...
      howItWorksDesc: 'Este rendimiento se genera a partir de señales de trading diarias ejecutadas automáticamente según reglas predefinidas. Las operaciones se ejecutan al cierre del mercado siguiente a la señal. Sin intervención manual, sin retrospectiva, sin apalancamiento.',
      ...
      tooltips: {
        totalReturn: 'Ganancia o pérdida total desde el inicio, expresada como porcentaje',
        cagr: 'Tasa de crecimiento anual compuesta - retorno promedio anual si las ganancias se reinvirtieran',
        maxDrawdown: 'La mayor caída de pico a valle durante el período registrado',
        winRate: 'Porcentaje de operaciones que resultaron en ganancia',
        tradeCount: 'Cantidad total de operaciones completadas con resultados resueltos',
        startDate: 'Cuando la estrategia comenzó a registrar señales',
      },
    },
  },
};
