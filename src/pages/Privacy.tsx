    ...
    <>
      ...
      <div className="min-h-screen bg-background py-16 px-4">
        <div className="max-w-3xl mx-auto prose prose-sm prose-neutral">
          ...
          <p>This Notice explains how ScreenerPilot ("we", "us") collects and uses personal data. ScreenerPilot is the <strong>data controller</strong> for the personal data described here.</p>
