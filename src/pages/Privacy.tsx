      ...
      <div className="min-h-screen bg-background py-16 px-4">
        <div className="max-w-3xl mx-auto prose prose-sm prose-neutral">
          ...
          <ul>
            ...
            <li><strong>Usage data</strong> — pages viewed, features used, watchlist contents, QUANT prompts, timestamps.</li>
          ...
          <ul>
            ...
            <li><strong>AI providers</strong> — prompts you send to QUANT are processed by an AI gateway in order to generate responses.</li>
