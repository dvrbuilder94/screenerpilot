    ...
    <>
      ...
      <div className="min-h-screen bg-background py-16 px-4">
        <div className="max-w-3xl mx-auto prose prose-sm prose-neutral">
          ...
          <p>These Terms govern your use of ScreenerPilot ("the Service"), provided by ScreenerPilot ("we", "us", "our"). By accessing or using the Service you agree to these Terms.</p>
          ...
          <h2>5. AI Features</h2>
          <p>The Service includes AI-generated outputs (e.g. AlexIA copilot, macro insights). Outputs may be inaccurate, incomplete or outdated. You are responsible for your prompts, your interpretation of outputs, and for verifying accuracy before acting. AI outputs are not professional advice.</p>
